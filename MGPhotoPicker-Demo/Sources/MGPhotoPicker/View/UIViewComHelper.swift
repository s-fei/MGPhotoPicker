...
class UIViewComHelper: NSObject
{
    ...
    static func realImageSize (_ image:UIImage?) -> CGSize
    {
        if image == nil
        {
            return CGSize()
...
//        view.layer.shadowPath = UIBezierPath(rect: view.bounds).CGPath
    ...
    static func tipsScallingImage(_ url : String? , imageView : UIImageView , withSize: ((CGSize) -> Void)? = nil)
    {
        if let realUrl = url
        {
    ...
    static func tipsScallingImage(_ imageUrl : String? ,placeHoldSting:String?, imageView : UIImageView , withSize: ((CGSize) -> Void)? = nil)
    {
    ...
    static func setupWebImage(_ originalUrlString:String?,
                       forImageView imageView:UIImageView,
                                    withPlaceHoldImage placeHolderImage:String?,
